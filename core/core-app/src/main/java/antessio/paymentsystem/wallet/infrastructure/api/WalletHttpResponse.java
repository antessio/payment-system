...
public class WalletHttpResponse {
    ...
    private PaginatedList<MovementHttpResponse> transfers;

    public WalletHttpResponse(String id, String type, String owner, Amount amount, PaginatedList<MovementHttpResponse> transfers) {
        this.id = id;
        this.type = type;
        this.owner = owner;
        this.amount = amount;
