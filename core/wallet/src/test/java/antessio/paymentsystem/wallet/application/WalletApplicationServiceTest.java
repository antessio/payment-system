...
class WalletApplicationServiceTest {
    ...
    void shouldLockFunds() {
        ...
        assertTransfers(
                walletOwnerId,
                tuple(amount.getAmountUnit(), MovementDirection.IN, WalletType.FUND_LOCK),
                tuple(amount.getAmountUnit(), MovementDirection.OUT, WalletType.MAIN));
    ...
    void shouldCollectFundLock() {
        ...
        assertTransfers(
                walletOwnerId,
                tuple(fundLockAmount, MovementDirection.OUT, WalletType.MAIN),
                tuple(fundLockAmount, MovementDirection.IN, WalletType.FUND_LOCK),
                tuple(fundLockAmount, MovementDirection.OUT, WalletType.FUND_LOCK));
        ...
        assertTransfers(
                destinationWalletOwnerId,
                tuple(fundLockAmount, MovementDirection.IN, WalletType.MAIN));
    }
    ...
    private void assertTransfers(WalletOwnerId walletOwnerId, Tuple... expectedTransfers) {
        List<Movement> transfersByWalletOwnerId = walletRepository.getTransfersByWalletOwnerId(walletOwnerId);
