...
public interface WalletRepository {
    ...
    Optional<Movement> loadTransferById(MovementId movementId);

    Stream<Movement> loadTransfersByWalletId(WalletID walletID, MovementId cursor);

    List<Movement> loadTransfersByOperationId(String operationId);
